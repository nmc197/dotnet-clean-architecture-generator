...
namespace TestProject.Infrastructure.Repositories
{
    public class CategoryRepository : RepositoryBase<Category, int>, ICategoryRepository
    {
        ...
        public CategoryRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<CategoryAggregate>> GetPagedAsync(CategoryDTParameters parameters)
        {
            ...
            var data = new DTResult<CategoryAggregate>
            {
