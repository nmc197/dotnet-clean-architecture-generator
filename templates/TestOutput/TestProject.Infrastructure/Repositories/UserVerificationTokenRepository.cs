...
namespace TestProject.Infrastructure.Repositories
{
    public class UserVerificationTokenRepository : RepositoryBase<UserVerificationToken, int>, IUserVerificationTokenRepository
    {
        ...
        public UserVerificationTokenRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<UserVerificationTokenAggregate>> GetPagedAsync(UserVerificationTokenDTParameters parameters)
        {
            ...
            var query = _context.UserVerificationTokens
                .Where(x => !x.IsDeleted)
                .Select(x => new UserVerificationTokenAggregate
                {
                    Id = x.Id,
                    Name = x.Name,
