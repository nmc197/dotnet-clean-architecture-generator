...
namespace TestProject.Infrastructure.Repositories
{
    public class RoleRepository : RepositoryBase<Role, int>, IRoleRepository
    {
        ...
        public RoleRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<RoleAggregate>> GetPagedAsync(RoleDTParameters parameters)
        {
