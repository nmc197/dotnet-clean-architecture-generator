...
namespace TestProject.Infrastructure.Repositories
{
    public class UserRepository : RepositoryBase<User, int>, IUserRepository
    {
        ...
        public UserRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<UserAggregate>> GetPagedAsync(UserDTParameters parameters)
        {
            ...
            var data = new DTResult<UserAggregate>
            {
