...
namespace TestProject.Infrastructure.Repositories
{
    public class SystemConfigRepository : RepositoryBase<SystemConfig, int>, ISystemConfigRepository
    {
        ...
        public SystemConfigRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<SystemConfigAggregate>> GetPagedAsync(SystemConfigDTParameters parameters)
        {
            ...
            var query = _context.SystemConfigs
                .Where(x => !x.IsDeleted)
                .Select(x => new SystemConfigAggregate
                {
                    Id = x.Id,
                    Name = x.Name,
            ...
            var data = new DTResult<SystemConfigAggregate>
            {
