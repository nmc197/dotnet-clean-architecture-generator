...
namespace TestProject.Infrastructure.Repositories
{
    public class ProvinceRepository : RepositoryBase<Province, int>, IProvinceRepository
    {
        ...
        public ProvinceRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<ProvinceAggregate>> GetPagedAsync(ProvinceDTParameters parameters)
        {
