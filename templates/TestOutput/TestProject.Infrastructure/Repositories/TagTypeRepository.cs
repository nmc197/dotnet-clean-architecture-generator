...
namespace TestProject.Infrastructure.Repositories
{
    public class TagTypeRepository : RepositoryBase<TagType, int>, ITagTypeRepository
    {
        ...
        public TagTypeRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<TagTypeAggregate>> GetPagedAsync(TagTypeDTParameters parameters)
        {
