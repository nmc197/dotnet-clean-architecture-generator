...
namespace TestProject.Infrastructure.Repositories
{
    public class PermissionRepository : RepositoryBase<Permission, int>, IPermissionRepository
    {
        ...
        public PermissionRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<PermissionAggregate>> GetPagedAsync(PermissionDTParameters parameters)
        {
            ...
            var data = new DTResult<PermissionAggregate>
            {
