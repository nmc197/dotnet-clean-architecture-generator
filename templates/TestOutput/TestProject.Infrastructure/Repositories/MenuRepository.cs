...
namespace TestProject.Infrastructure.Repositories
{
    public class MenuRepository : RepositoryBase<Menu, int>, IMenuRepository
    {
        ...
        public MenuRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<MenuAggregate>> GetPagedAsync(MenuDTParameters parameters)
        {
            ...
            var data = new DTResult<MenuAggregate>
            {
