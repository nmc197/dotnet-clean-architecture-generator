...
namespace TestProject.Infrastructure.Repositories
{
    public class FileUploadRepository : RepositoryBase<FileUpload, int>, IFileUploadRepository
    {
        ...
        public FileUploadRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<FileUploadAggregate>> GetPagedAsync(FileUploadDTParameters parameters)
        {
            ...
            var query = _context.FileUploads
                .Where(x => !x.IsDeleted)
                .Select(x => new FileUploadAggregate
                {
                    Id = x.Id,
                    Name = x.Name,
            ...
            var data = new DTResult<FileUploadAggregate>
            {
