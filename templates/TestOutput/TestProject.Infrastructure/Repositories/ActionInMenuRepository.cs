...
namespace TestProject.Infrastructure.Repositories
{
    public class ActionInMenuRepository : RepositoryBase<ActionInMenu, int>, IActionInMenuRepository
    {
        ...
        public ActionInMenuRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<ActionInMenuAggregate>> GetPagedAsync(ActionInMenuDTParameters parameters)
        {
            ...
            var query = _context.ActionInMenus
                .Where(x => !x.IsDeleted)
                .Select(x => new ActionInMenuAggregate
                {
                    Id = x.Id,
                    Name = x.Name,
            ...
            var data = new DTResult<ActionInMenuAggregate>
            {
