...
namespace TestProject.Infrastructure.Repositories
{
    public class FolderUploadRepository : RepositoryBase<FolderUpload, int>, IFolderUploadRepository
    {
        ...
        public FolderUploadRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<FolderUploadAggregate>> GetPagedAsync(FolderUploadDTParameters parameters)
        {
            ...
            var query = _context.FolderUploads
                .Where(x => !x.IsDeleted)
                .Select(x => new FolderUploadAggregate
                {
                    Id = x.Id,
                    Name = x.Name,
            ...
            var data = new DTResult<FolderUploadAggregate>
            {
