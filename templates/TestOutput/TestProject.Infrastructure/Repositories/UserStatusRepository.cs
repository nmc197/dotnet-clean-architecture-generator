...
namespace TestProject.Infrastructure.Repositories
{
    public class UserStatusRepository : RepositoryBase<UserStatus, int>, IUserStatusRepository
    {
        ...
        public UserStatusRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<UserStatusAggregate>> GetPagedAsync(UserStatusDTParameters parameters)
        {
