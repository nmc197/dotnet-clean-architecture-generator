...
namespace TestProject.Infrastructure.Repositories
{
    public class UserSessionRepository : RepositoryBase<UserSession, int>, IUserSessionRepository
    {
        ...
        public UserSessionRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<UserSessionAggregate>> GetPagedAsync(UserSessionDTParameters parameters)
        {
            ...
            var query = _context.UserSessions
                .Where(x => !x.IsDeleted)
                .Select(x => new UserSessionAggregate
                {
                    Id = x.Id,
                    Name = x.Name,
            ...
            var data = new DTResult<UserSessionAggregate>
            {
