...
namespace TestProject.Infrastructure.Repositories
{
    public class UserNotificationRepository : RepositoryBase<UserNotification, int>, IUserNotificationRepository
    {
        ...
        public UserNotificationRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<UserNotificationAggregate>> GetPagedAsync(UserNotificationDTParameters parameters)
        {
            ...
            var query = _context.UserNotifications
                .Where(x => !x.IsDeleted)
                .Select(x => new UserNotificationAggregate
                {
                    Id = x.Id,
                    Name = x.Name,
            ...
            var data = new DTResult<UserNotificationAggregate>
            {
