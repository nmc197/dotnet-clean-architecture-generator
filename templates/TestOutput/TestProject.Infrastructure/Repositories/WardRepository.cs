...
namespace TestProject.Infrastructure.Repositories
{
    public class WardRepository : RepositoryBase<Ward, int>, IWardRepository
    {
        ...
        public WardRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<WardAggregate>> GetPagedAsync(WardDTParameters parameters)
        {
