...
namespace TestProject.Infrastructure.Repositories
{
    public class NotificationTypeRepository : RepositoryBase<NotificationType, int>, INotificationTypeRepository
    {
        ...
        public NotificationTypeRepository(TestProjectContext context, IUnitOfWork unitOfWork, IStorageService storageService) 
        ...
        public async Task<DTResult<NotificationTypeAggregate>> GetPagedAsync(NotificationTypeDTParameters parameters)
        {
